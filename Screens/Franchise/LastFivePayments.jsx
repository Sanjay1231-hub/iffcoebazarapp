...
const renderItem = ({ item }) => (
    <View style={styles.row}>
        <Text style={[styles.cell, {flex: 2.7, textAlign: 'left'}]}>{item.UTR_NO}</Text>
        <Text style={[styles.cell, {flex: 1.2, textAlign: 'right'}]}>{item.DD_DT}</Text>
        <Text style={[styles.cell, {flex: 1, textAlign: 'right'}]}>{formatIndianNumber(item.AMOUNT)}</Text>       
    </View>
);

  return (
    <View style={styles.container}>   
        <Text style={styles.asondate}>Last Five Payments</Text>       
          <View style={styles.headerContainer}>
            <View style={styles.header}>
              <Text style={[styles.headerCell, { flex: 2.5 }]}>UTR.No.</Text>
...
export default LastFivePayments;
