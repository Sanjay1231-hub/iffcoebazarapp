...
const FranchisePage = () => {
  ...
  const clickPartyBalanceConfirmationOtp =() => {
    navigation.navigate('PartyBalanceConfirmationOtp'); // Navigate to EmployeeDirectory screen
  }; 
  const clickLastFivePayments =() => {
    navigation.navigate('LastFivePayments'); // Navigate to EmployeeDirectory screen
  }; 
  const clickLastFiveInvoices =() => {
    navigation.navigate('LastFiveInvoices'); // Navigate to EmployeeDirectory screen
  };   
  const clickIndent =() => {
    navigation.navigate('IndentScreen'); // Navigate to EmployeeDirectory screen
  };   
  return (
