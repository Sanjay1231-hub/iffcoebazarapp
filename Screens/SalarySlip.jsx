...
const styles = StyleSheet.create({
  ...
  modal_container: { flexDirection: 'row', alignItems: 'center', marginBottom: 5 },
  textInput: { fontSize: 15, color: '#333', borderColor: '#ccc', borderWidth: 1, borderRadius: 5, paddingHorizontal: 10, minHeight: 35 },
  buttonLov: { height: 35, justifyContent: 'center', alignItems: 'center', backgroundColor: '#007BFF', borderRadius: 5, paddingHorizontal: 5, marginRight: -33, zIndex: 1 },
  ...
  backButton: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#208cf3', padding: 10 }
});
