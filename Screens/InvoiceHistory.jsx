    ...
    const RenderItemComponent = React.memo(({ item }) => (        
        <View style={styles.row}>
            ...
            <View style={[styles.cell, { flex: 0.5, alignItems: 'center' }]}>          
                <TouchableOpacity onPress={() => downloadPdf(item)} style={{padding: 0,}}>
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.header}>                           
            ...
            <Text style={[styles.headerText, { flex: 1.2, textAlign: 'center' }]}>Date</Text>
            {/* <Text style={[styles.headerText, { flex: 2, textAlign: 'center' }]}>Customer</Text> */}
            ...
            <Text style={[styles.headerText, { flex: 0.6, textAlign: 'center' }]}>Pdf</Text>
        </View>
