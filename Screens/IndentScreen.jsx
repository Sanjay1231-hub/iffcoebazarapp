            ...
            <View style={styles.modalContainer}>
                <View style={styles.modalContent}>
                    ...
                    <View style={styles.header}>
                        <Text style={[styles.headerText, { flex: 2, textAlign: "left" }]}>
                            Product Name
                        </Text>
                    ...
                    <FlatList
                        ...
                        renderItem={({ item }) => (
                            ...
                            <View style={styles.row}>  
                                <Text style={[styles.cell, { flex: 2, textAlign: 'left' }]}>{item.PRD_DESC || 'No Data'}</Text> 
                                <Text style={[styles.cell, { flex: 1, textAlign: 'left' }]}>{item.PRD_CD || 'No Prd Code'}</Text>                      
                            </View>
                            </TouchableOpacity>
                        )}
        ...
        <TouchableOpacity style={styles.addBtn} onPress={handleAddProduct}>
            <Text style={styles.addBtnText}>+ Add Product</Text>
                ...
                <View style={styles.tableContainer}>
                    ...
                    <Text style={[styles.headerText, { flex: 1.2, textAlign: "center" }]}>Product</Text>
                    ...
                    <FlatList
                        ...
                        renderItem={({ item }) => (
                            ...
                            <Text style={[styles.cell, { flex: 1.2, textAlign: "left" }]}>{item.productDesc}</Text>
                        ...
                        ListFooterComponent={() => {
                            ...
                            <View style={[styles.tableTotalRow, { borderTopWidth: 1, borderColor: "#ccc", marginTop: 4 }]}>
                                <Text style={[styles.cell, { flex: 1.1, textAlign: "left", fontWeight: "500" }]}>Total:</Text>
                            
                                <Text style={[styles.cell, { flex: 1.3 }]}></Text>
