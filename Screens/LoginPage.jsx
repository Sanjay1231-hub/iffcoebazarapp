...
import { View, Text, TouchableOpacity, StyleSheet, Alert, ImageBackground, Platform, Image, ActivityIndicator, TextInput,  KeyboardAvoidingView,
...
const LoginPage = ({ onLogin }) => {
  ...
  const [frBAPassword, setFrBAPassword] = useState(false); // State to check if OTP was sent
...
const styles = StyleSheet.create({
  ...
  rowButton: {
   ...
   passinputContainer: {
    width: '100%',
    flexDirection: 'row',
    alignItems: 'center',      // centers icon & input vertically
    backgroundColor: '#fff',
    borderRadius: 5,
    paddingHorizontal: 10,
    marginBottom: 10,
